...
<body>
    ...
    <main>
        <h2 style="color: var(--azul-oscuro); margin-bottom: 1.5rem;">Mis pedidos</h2>
    ...
    <script src="assets/js/mis-pedidos.js?v=<?php echo filemtime(__DIR__ . '/assets/js/mis-pedidos.js'); ?>"></script>
</body>
</html>

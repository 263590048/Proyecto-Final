...
<body>
    ...
    <main>
        <section class="confirmacion-pedido" id="confirmacion-pedido">
    ...
    <script src="assets/js/confirmacion.js?v=<?php echo filemtime(__DIR__ . '/assets/js/confirmacion.js'); ?>"></script>
</body>
</html>
